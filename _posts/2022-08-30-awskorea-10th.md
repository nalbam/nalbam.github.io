...
AWS DeepRacer 는 발표하였지만, 아직 요즘과 같은 DeepRacer 콘솔을 존재 하지 않았습니다. `SageMaker` 와 `RoboMaker` 를 이용해서 훈련을 해야 했고, `AWS Community Day 2019` 에서 훈련 하는 방법을 발표 했습니다.
...
AWS DeepRacer 외에 본 직업은 DevOps Engineer 이므로 `GitOps` 관련 발표도 했습니다.
...
온라인으로 열린 `AWS Community Day online 2020` 에서는 딥레이서 커무니티 리그를 온라인으로 진행 했습니다.

{% include youtube.html id="c96rYjRa6Tw" %}

## AWS DeepRacer Hero 선정
...
![Welcome to Las Vegas](/assets/images/2022-08-30/Welcome-to-Las-Vegas.png)
